class McpBrainRouter < Formula
  ...
  url "https://github.com/mohan-n-swamy/mcp-brain-router/archive/refs/tags/v0.1.1.tar.gz"
  sha256 "d2c80a6006beb2dd5c33237bad6a53941b9d87046bd446acba3e42f1420bebe7"
  license "MIT"

  depends_on "certifi"
  depends_on "python@3.12"
  depends_on "rust" => :build  # cryptography / pydantic-core / rpds-py build native ext
  ...
  test do
    # --version short-circuits before the blocking stdio loop, so this never hangs.
    assert_match "mcp-brain-router #{version}", shell_output("#{bin}/mcp-brain-router --version")
  end
end
