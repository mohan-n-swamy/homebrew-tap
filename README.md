...
| Formula | Description |
|---|---|
| [`coding-control-tower`](https://github.com/mohan-n-swamy/coding-control-tower) | Local, project-first dashboard for coding sessions and pull requests |
